                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col_4 col">
                            <img className="mar" alt="logo" src={Post_1} />
                        </div>
                        <div className="col_4 col">
                            <img className="mar" alt="logo" src={Post_2} />
                        </div>
                        <div className="col_4 col">
                            <img className="mar" alt="logo" src={Post_3} />
                        </div>
                        <div className="col_4 col">
                            <img className="mar" alt="logo" src={Post_4} />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col_4 col">
                            <img className="mar" alt="logo" src={Post_5} />
                        </div>
                        <div className="col_4 col">
                            <img className="mar" alt="logo" src={Post_6} />
                        </div>
                        <div className="col_4 col">
                            <img className="mar" alt="logo" src={Post_7} />
                        </div>
                        <div className="col_4 col">
                            <img className="mar" alt="logo" src={Post_8} />
                        </div>
                    </div>
                    <div className="row">
                        <div className="col_4 col">
                            <img className="mar" alt="logo" src={Post_9} />
                        </div>
                        <div className="col_4 col">
                            <img className="mar" alt="logo" src={Post_10} />
                        </div>
                        <div className="col_4 col">
                            <img className="mar" alt="logo" src={Post_11} />
                        </div>
                        <div className="col_4 col">
                            <img className="mar" alt="logo" src={Post_12} />
                        </div>
                    </div>
                </div>
            </div>
